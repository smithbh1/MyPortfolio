      ...
      case 'register':
        ...
        case 'modClient':
          ...
          if(!($clientEmail == $_SESSION['clientData']['clientEmail'])){
            $existingEmail =checkExistingEmail($clientEmail);
            if($existingEmail === 1){
              $_SESSION['message'] = '<p>It looks like that email is already in use, try logging in.</p>';
              include '../view/login.php';
              exit; 
            }
          }
          ...
          if ($updateResult) {
            $_SESSION['message'] = "<p class='notify'>Congratulations, your account was successfully updated.</p>";
          ...
          $_SESSION['message'] = "<p>Error. The account was not updated.</p>";
            include '../view/client-update.php';
            exit;
        }
        ...
        case "modPassword" :
          ...
          if(empty($checkPassword)){
            $_SESSION['message'] = '<p class="notice">Please provide a valid password.</p>';
            include '../view/client-update.php';
            exit;
          }
          $passUpdateResult = updatePassword($clientId, $clientPassword);
          ...
          if($passUpdateResult) {
            ...
            $_SESSION['message'] = "<p>Error. The password was not updated.</p>";
            include '../view/client-update.php';
            exit;
          }
